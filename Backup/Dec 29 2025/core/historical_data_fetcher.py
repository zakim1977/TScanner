...
class HistoricalDataImporter:
    ...
    def import_historical_data(self, symbols: List[str] = None, lookback_days: int = 180, interval: str = "4h", skip_existing: bool = True) -> Dict:
    ...
    def _backtest_symbol_outcomes(self, symbol: str, data: list):
        ...
        try:
            ...
            if updated > 0:
                print(f"    ✓ Backtest: {updated} outcomes calculated for {symbol}")
