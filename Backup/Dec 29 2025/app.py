            ...
            if df is not None and len(df) >= 50:
                ...
                with st.expander(learning_title, expanded=False):
                    ...
                    if current_analysis_mode == AnalysisMode.ML:
                        ...
                        if ml_prediction:
                            ...
                            <div style='background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); 
                                ...
                                <div style='margin-top: 10px; color: #aaa;'>
                                    <span style='color: #888;'>Top Factors:</span> {', '.join(ml_prediction.top_factors[:3]) if ml_prediction.top_factors else 'N/A'}
                                </div>
                            </div>
                            """, unsafe_allow_html=True)
                        ...
                        agreement = (rules_bullish and ml_bullish) or (not rules_bullish and not ml_bullish) or ml_direction == "WAIT"
