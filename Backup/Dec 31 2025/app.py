...
def calculate_explosion_for_scanner(df, whale_pct: float, retail_pct: float, oi_change: float) -> dict:
    ...
    try:
        ...
        return {
            ...
            'squeeze_pct': explosion.get('squeeze', {}).get('squeeze_percentile', 50),
        }
    except:
    ...
    try:
            ...
            try:
                ...
                if is_ml_available():
                    ...
                    if current_analysis_mode == AnalysisMode.ML:
                        ...
                        # Calculate BB squeeze % for compression detection
                        squeeze_pct_hybrid = 50  # Default
                        try:
                            ...
                            if bb_upper and bb_lower and bb_upper > bb_lower:
                                ...
                                if bb_width <= 1.0:
                                    squeeze_pct_hybrid = 95
                                elif bb_width <= 1.5:
                                    squeeze_pct_hybrid = 85
                                elif bb_width <= 2.0:
                                    squeeze_pct_hybrid = 75
                                elif bb_width <= 2.5:
                                    squeeze_pct_hybrid = 65
                                elif bb_width <= 3.0:
                                    squeeze_pct_hybrid = 55
                                else:
                                    squeeze_pct_hybrid = max(20, 100 - bb_width * 15)
                        except:
                            squeeze_pct_hybrid = 50
                        ...
                        hybrid_result = blend_hybrid_prediction(
                            ...
                            structure=structure_type,   # For STRUCTURE OVERRIDE detection
        ...
        if signal:
            try:
                ...
                # ONLY calculate limit entry if we have a valid trade direction
                # If trade_direction is WAIT, skip entirely (no misleading limit entries)
...
with st.sidebar:
    ...
    if app_mode == "🔍 Scanner":
        ...
        st.markdown(f"""
        <div style='background: #1a1a2e; border: 1px solid {mode_config['color']}; border-radius: 6px; 
            ...
            <div style='color: #aaa; margin-top: 3px;'>
                Chart: <strong style='color: #00d4ff;'>{mode_config['default_tf']}</strong> | 
                HTF Context: <strong style='color: #00d4ff;'>{mode_config['htf_context']}</strong>
            </div>
        </div>
        """, unsafe_allow_html=True)
            ...
            for tf in timeframes_to_scan:
                ...
                try:
                    ...
                    if df is not None and len(df) >= 50:
                        ...
                        # Rebuild entire live display (sorted by score)
                        live_signals_list.sort(key=lambda x: x['score'], reverse=True)
                        ...
                        for sig_item in live_signals_list[:10]:  # Show top 10 live
                            dir_color = "#00ff88" if sig_item['direction'] == "LONG" else "#ff6b6b"
                                    ...
                                    if analysis and 'error' not in analysis:
                                        ...
                                        if pred_result and not is_in_danger_zone:
                                            ...
                                            combined_learning = generate_combined_learning(
                                                ...
                                                # Explosion data not available in Trade Monitor live analysis
                                                explosion_data=None,
                                            )
                ...
                with col_levels:
                    if is_investment:
                        ...
                        if optimizer_wait:
                            ...
                            # Show TPs for WAIT with descriptions
                            st.markdown(f"""
                            <div style='background: #1a2a1a; padding: 10px 15px; border-radius: 6px; margin: 5px 0; border-left: 3px solid #00d4aa;'>
                                ...
                                <div style='color: #88ddaa; font-size: 0.8em; margin-top: 4px;'>📍 {wait_tp1_desc}</div>
                            </div>
                            <div style='background: #1a2a1a; padding: 10px 15px; border-radius: 6px; margin: 5px 0; border-left: 3px solid #00d4aa;'>
                                <div style='display: flex; justify-content: space-between; align-items: center;'>
                                ...
                                <div style='color: #88ddaa; font-size: 0.8em; margin-top: 4px;'>📍 {wait_tp2_desc}</div>
                            </div>
                            <div style='background: #1a2a1a; padding: 10px 15px; border-radius: 6px; margin: 5px 0; border-left: 3px solid #00d4aa;'>
                                <div style='display: flex; justify-content: space-between; align-items: center;'>
                                ...
                                <div style='color: #88ddaa; font-size: 0.8em; margin-top: 4px;'>📍 {wait_tp3_desc}</div>
                            </div>
                            """, unsafe_allow_html=True)
                            ...
                            # TPs with ROI%, R:R, and DESCRIPTIONS
                            st.markdown(f"""
                            <div style='background: #1a2a1a; padding: 10px 15px; border-radius: 6px; margin: 5px 0; border-left: 3px solid #00d4aa;'>
                                <div style='display: flex; justify-content: space-between; align-items: center;'>
                                ...
                                <div style='color: #88ddaa; font-size: 0.8em; margin-top: 4px;'>📍 {tp1_desc}</div>
                            </div>
                            <div style='background: #1a2a1a; padding: 10px 15px; border-radius: 6px; margin: 5px 0; border-left: 3px solid #00d4aa;'>
                                <div style='display: flex; justify-content: space-between; align-items: center;'>
                                ...
                                <div style='color: #88ddaa; font-size: 0.8em; margin-top: 4px;'>📍 {tp2_desc}</div>
                            </div>
                            <div style='background: #1a2a1a; padding: 10px 15px; border-radius: 6px; margin: 5px 0; border-left: 3px solid #00d4aa;'>
                                <div style='display: flex; justify-content: space-between; align-items: center;'>
                                ...
                                <div style='color: #88ddaa; font-size: 0.8em; margin-top: 4px;'>📍 {tp3_desc}</div>
                            </div>
                            """, unsafe_allow_html=True)
