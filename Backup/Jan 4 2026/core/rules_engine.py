...
DEFAULT_CONFIG = {
    ...
    "thresholds": {
        "oi_change": {
            "significant_positive": 0.5,   # OI rising = new positions (lowered from 1.0)
            "significant_negative": -0.5,  # OI falling = closing positions (lowered from -1.0)
            "strong_positive": 2.0,        # Strong conviction (lowered from 3.0)
            "strong_negative": -2.0        # Strong exit (lowered from -3.0)
        },
        "price_change": {
    ...
    "scenarios": {
        ...
        # ─────────────────────────────────────────────────────────────────────────
        # WHALE POSITIONING WITH NEUTRAL OI (New scenarios!)
        # When OI isn't moving but whales have taken a position
        # ─────────────────────────────────────────────────────────────────────────
        "WHALE_BULLISH_OI_NEUTRAL": {
            "name": "Whale Bullish (OI Stable)",
            "emoji": "🟢",
            "required": {
                "oi_price_pattern": "NEUTRAL",
                "whale_bias": "BULLISH"
            },
            "confidence": "MEDIUM",
            "direction": "LONG",
            "status": "WAIT",
            "score": 60,
            "description": "Whales positioned long, waiting for OI confirmation",
            "action": "Cautious long with OI confirmation, tight stops",
            "education": "Whales are bullish but no new money entering yet. This could be accumulation before a move. Wait for OI to confirm or trade cautiously."
        },
        "WHALE_BEARISH_OI_NEUTRAL": {
            ...
            "status": "WAIT",
            "score": 40,
            "description": "Whales positioned short, waiting for OI confirmation",
            "action": "Cautious short with OI confirmation, tight stops",
            "education": "Whales are bearish but no new money entering shorts yet. This could be distribution before a drop. Wait for OI to confirm or trade cautiously."
        },
