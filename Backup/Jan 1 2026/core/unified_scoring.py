                ...
                if final_verdict == 'WAIT':
                    ...
                    if ml_prediction and ml_prediction != 'WAIT' and engine_mode == 'hybrid':
                        if direction in ['BULLISH', 'LEAN_BULLISH'] and ml_prediction == 'SHORT':
                            wait_reasons.append("ML/Rules conflict")
                    ...
                    if engine_mode == 'hybrid' and ml_prediction:
                        if ml_prediction == 'LONG':
                            ...
                            conflicts.append(f"🤖 ML predicts SHORT vs bullish positioning")
                    ...
                    if ml_prediction == 'LONG' and engine_mode == 'hybrid':
                        long_factors.append("ML confirms")
                    ...
                    if engine_mode == 'hybrid' and ml_prediction:
                        if ml_prediction == 'SHORT':
                            conflicts.append(f"⚠️ ML predicts SHORT - use caution")
                        elif ml_prediction == 'WAIT':
                            conflicts.append(f"🤖 ML predicts WAIT - consider smaller size")
                    ...
                    if ml_prediction == 'SHORT' and engine_mode == 'hybrid':
                        short_factors.append("ML confirms")
                    ...
                    if engine_mode == 'hybrid' and ml_prediction:
                        if ml_prediction == 'LONG':
                            conflicts.append(f"⚠️ ML predicts LONG - use caution")
                        elif ml_prediction == 'WAIT':
                            conflicts.append(f"🤖 ML predicts WAIT - consider smaller size")
            else:
...
"""
            ...
            # 8. ML alignment (if hybrid)
            if engine_mode == 'hybrid' and ml_prediction:
                if ml_prediction == final_verdict:
                    unified_parts.append("✅ ML confirms")
                elif ml_prediction == 'WAIT':
                    unified_parts.append("🤖 ML says WAIT")
                elif ml_prediction != final_verdict and final_verdict in ['LONG', 'SHORT']:
                    unified_parts.append(f"⚠️ ML says {ml_prediction}")
