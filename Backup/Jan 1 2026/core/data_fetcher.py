    ...
    try:
        ...
        if response.status_code == 200:
            ...
            try:
                ...
                pass  # If volume fetch fails, use unsorted list
...
def get_default_futures_pairs() -> list:
    """
    Default Binance Futures pairs - ALL verified to have futures contracts.
    These are available globally (Dubai, Europe, Asia) - NOT Binance US.
    """
    return [
        # Top by volume - definitely have futures
        "BTCUSDT", "ETHUSDT", "BNBUSDT", "XRPUSDT", "SOLUSDT",
        "DOGEUSDT", "ADAUSDT", "AVAXUSDT", "LINKUSDT", "DOTUSDT",
        "TRXUSDT", "MATICUSDT", "LTCUSDT", "BCHUSDT", "ATOMUSDT",
        ...
        # Memes (high volume futures)
        "SHIBUSDT", "PEPEUSDT", "WIFUSDT", "FLOKIUSDT", "BONKUSDT",
        # AI/Compute
        "FETUSDT", "RENDERUSDT", "TAOUSDT", "AGIXUSDT", "OCEANUSDT",
        # Infrastructure
