...
def render_historical_validation_html(
    ...
    if hist_validation and hist_validation.matches_found >= 20:
        ...
        <div style='display: flex; gap: 15px; align-items: center; flex-wrap: wrap;'>
            <div style='background: {hist_bg}; padding: 5px 10px; border-radius: 4px;'>
                <span style='color: #888; font-size: 0.75em;'>Win Rate:</span>
                <span style='color: {hist_color}; font-weight: bold;'> {hist_validation.win_rate:.0f}%</span>
            </div>
            <div style='background: #1a1a2e; padding: 5px 10px; border-radius: 4px;'>
                <span style='color: #888; font-size: 0.75em;'>ETA TP1:</span>
                <span style='color: #00ff88;'> {hist_validation.avg_time_to_tp1}</span>
            </div>
            <div style='background: #1a1a2e; padding: 5px 10px; border-radius: 4px;'>
                <span style='color: #888; font-size: 0.75em;'>ETA SL:</span>
                <span style='color: #ff6b6b;'> {hist_validation.avg_time_to_sl}</span>
            </div>
            <span style='color: {"#00ff88" if hist_validation.alignment == "ALIGNED" else "#ffcc00"}; font-size: 0.85em;'>
