...
MODE_CONFIG = {
    'Scalp': {
        ...
        'vwap_weight': 15,       # HIGH - VWAP critical for scalping
    },
    'DayTrade': {
        'timeframes': ['15m', '1h'],
        'max_sl_pct': 5.0,
        ...
        'atr_buffer_mult': 1.2,
        'vwap_weight': 12,       # HIGH - VWAP important for day trading
    },
    'Swing': {
        'timeframes': ['4h', '1d'],
        'max_sl_pct': 10.0,
        ...
        'atr_buffer_mult': 1.5,
        'vwap_weight': 6,        # MEDIUM - VWAP less relevant for multi-day
    },
    'Investment': {
        'timeframes': ['1w'],
        'max_sl_pct': 15.0,
        ...
        'atr_buffer_mult': 2.0,
        'vwap_weight': 2,        # LOW - VWAP minimal for long-term
    },
}
